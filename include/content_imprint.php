			...
			<div class="grid-100">
				<div class="news-detail-content">
					...
					<div><strong><?php the_field('imprint-company', 'option'); ?></strong></div>
                        ...
                        <div class="imprint-left"><?php _e('Vertretungsberechtigter'); ?>:</div><div><?php the_field('imprint-representative', 'option'); ?></div>
                        <div class="imprint-left"><?php _e('Verantwortlich für den Inhalt'); ?>:</div><div><?php the_field('imprint-contentrespons', 'option'); ?></div>
                        <div class="clearfix"></div>
                    </div>
                    <h2><?php _e('Haftungsausschluss'); ?></h2>
                    <div><?php the_field('imprint-disclaimer', 'option'); ?></div>
